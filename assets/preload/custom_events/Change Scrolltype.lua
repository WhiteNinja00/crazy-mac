...
function onCreatePost()
	...
	if chartingMode then
		...
		-- Cool, shitty title
		makeLuaText('titleorsmthTxt', '', width, 80, ycord + 30)
		setTextSize('titleorsmthTxt', 34)
		addLuaText('titleorsmthTxt')
		
		-- Vertical Label
		makeLuaText('vertTxt', '' .. (Vertical and 'On' or 'Off'), width, 57, ycord + 60)
		setTextSize('vertTxt', 48)
		addLuaText('vertTxt')
		
		-- Horizontal Label
		makeLuaText('horiTxt', '' .. (Horizontal and 'On' or 'Off'), width, 57, ycord + 110)
		setTextSize('horiTxt', 48)
		addLuaText('horiTxt')
		
		-- Strum Label
		makeLuaText('strumsTxt', '' .. (StrumSwap and 'On' or 'Off'), width, 57, ycord + 160)
		setTextSize('strumsTxt', 48)
		addLuaText('strumsTxt')

		-- Section Label
		makeLuaText('sectionTxt', '' .. (gfSection and 'Dancer' or mustHitSection and 'Player' or 'Opponent'), width, 57, ycord + 210)
...
function onUpdate()
	...
	if updateLabels == true then
		setTextString('vertTxt', '' .. (Vertical and '' or ''))
		setTextString('horiTxt', '' .. (Horizontal and '' or ''))
		setTextString('strumsTxt', '' .. (StrumSwap and '' or ''))
		setTextString('sectionTxt', '' .. (gfSection and 'Dancer' or mustHitSection and 'Player' or 'Opponent'))
